...
cc.CCDirector.prototype = {
	...
	,replaceScene: function(scene) {
		this.popScene();
		if(Std["is"](scene,cc.layerandscenes.CCTransitionScene)) {
			var s = js.Boot.__cast(scene , cc.layerandscenes.CCTransitionScene);
...
cc.basenodes.CCNode.prototype = {
	...
	,addChild: function(child,zOrder,tag) {
		...
		var tempzOrder;
		if(zOrder == null) tempzOrder = child.getZOrder(); else tempzOrder = zOrder;
		var tempTag;
...
cc.layerandscenes = {}
cc.layerandscenes.CCLayer = function() {
	this._pointerPriority = 0;
	this._isPointerEnabled = false;
	cc.basenodes.CCNode.call(this);
};
cc.layerandscenes.CCLayer.__name__ = true;
cc.layerandscenes.CCLayer.__interfaces__ = [cc.touchdispatcher.CCPointerEventDelegate];
cc.layerandscenes.CCLayer.__super__ = cc.basenodes.CCNode;
cc.layerandscenes.CCLayer.prototype = $extend(cc.basenodes.CCNode.prototype,{
	...
	,__class__: cc.layerandscenes.CCLayer
});
cc.layerandscenes.CCScene = function() {
	cc.basenodes.CCNode.call(this);
};
cc.layerandscenes.CCScene.__name__ = true;
cc.layerandscenes.CCScene.create = function() {
	return new cc.layerandscenes.CCScene();
}
cc.layerandscenes.CCScene.__super__ = cc.basenodes.CCNode;
cc.layerandscenes.CCScene.prototype = $extend(cc.basenodes.CCNode.prototype,{
	init: function() {
		cc.basenodes.CCNode.prototype.init.call(this);
		this.setAnchorPoint(new flambe.math.Point(0,0));
	...
	,__class__: cc.layerandscenes.CCScene
});
cc.layerandscenes.CCTransitionScene = function() {
	cc.layerandscenes.CCScene.call(this);
};
cc.layerandscenes.CCTransitionScene.__name__ = true;
cc.layerandscenes.CCTransitionScene.create = function(t,scene) {
	var ret = new cc.layerandscenes.CCTransitionScene();
	if(ret != null && ret.initWithDuration(t,scene)) return ret;
	return null;
}
cc.layerandscenes.CCTransitionScene.__super__ = cc.layerandscenes.CCScene;
cc.layerandscenes.CCTransitionScene.prototype = $extend(cc.layerandscenes.CCScene.prototype,{
	getInScene: function() {
	...
	,__class__: cc.layerandscenes.CCTransitionScene
});
cc.layerandscenes.CCTransitionFade = function() {
	cc.layerandscenes.CCTransitionScene.call(this);
};
cc.layerandscenes.CCTransitionFade.__name__ = true;
cc.layerandscenes.CCTransitionFade.create = function(t,scene,color) {
	var ret = new cc.layerandscenes.CCTransitionFade();
	ret.initWithDuration(t,scene);
	return ret;
}
cc.layerandscenes.CCTransitionFade.__super__ = cc.layerandscenes.CCTransitionScene;
cc.layerandscenes.CCTransitionFade.prototype = $extend(cc.layerandscenes.CCTransitionScene.prototype,{
	initWithDuration: function(t,scene) {
		cc.layerandscenes.CCTransitionScene.prototype.initWithDuration.call(this,t,scene);
		this.transition = new flambe.scene.FadeTransition(t);
		return true;
	}
	,__class__: cc.layerandscenes.CCTransitionFade
});
cc.menunodes = {}
cc.menunodes.CCMenu = function() {
	this._enabled = false;
	this._state = -1;
	cc.layerandscenes.CCLayer.call(this);
	this.sprite = new flambe.display.Sprite();
	this.entity.add(this.sprite);
	this.component = new cc.CCComponent(this);
	this.entity.add(this.component);
...
cc.menunodes.CCMenu.__super__ = cc.layerandscenes.CCLayer;
cc.menunodes.CCMenu.prototype = $extend(cc.layerandscenes.CCLayer.prototype,{
	...
	,onExit: function() {
		...
		cc.layerandscenes.CCLayer.prototype.onExit.call(this);
	}
	,onPointerDragged: function(event) {
	...
	,registerWithTouchDispatcher: function() {
		cc.layerandscenes.CCLayer.prototype.registerWithTouchDispatcher.call(this);
	...
	,addChild: function(child,zOrder,tag) {
		...
		cc.layerandscenes.CCLayer.prototype.addChild.call(this,child,zOrder,tag);
	}
...
flambe.display.Sprite.getFrom = function(entity) {
	return entity.getComponent("Sprite_3");
}
...
sample.AboutLayer.__super__ = cc.layerandscenes.CCLayer;
sample.AboutLayer.prototype = $extend(cc.layerandscenes.CCLayer.prototype,{
	backCallback: function() {
		var scene = cc.layerandscenes.CCScene.create();
		scene.addChild(sample.SysMenu.create());
		cc.CCDirector.getInstance().replaceScene(scene);
	}
	,init: function() {
		var bRet = false;
		if(cc.layerandscenes.CCLayer.prototype.init.call(this)) {
...
sample.GameLayer.__super__ = cc.layerandscenes.CCLayer;
sample.GameLayer.prototype = $extend(cc.layerandscenes.CCLayer.prototype,{
	movingBackground: function() {
		...
		if(this._backSkyHeight <= sample.GameLayer.winSize.height) {
			if(!this._isBackSkyReload) {
				...
				this.addChild(this._backSkyRe);
				var p = this._ship.getPosition();
				this.removeChild(this._ship,false);
				this._ship._parent = null;
	...
	,update: function(dt) {
		cc.layerandscenes.CCLayer.prototype.update.call(this,dt);
		this.checkIsCollide();
	}
	...
	,onPointerDragged: function(event) {
		...
		return cc.layerandscenes.CCLayer.prototype.onPointerMoved.call(this,event);
	}
	,onPointerMoved: function(event) {
		this.processEvent(event);
		return cc.layerandscenes.CCLayer.prototype.onPointerMoved.call(this,event);
...
sample.SettingsLayer.__super__ = cc.layerandscenes.CCLayer;
sample.SettingsLayer.prototype = $extend(cc.layerandscenes.CCLayer.prototype,{
	backCallback: function() {
		var scene = cc.layerandscenes.CCScene.create();
		scene.addChild(sample.SysMenu.create());
		cc.CCDirector.getInstance().replaceScene(scene);
...
sample.SysMenu.__super__ = cc.layerandscenes.CCLayer;
sample.SysMenu.prototype = $extend(cc.layerandscenes.CCLayer.prototype,{
	...
	,onNewGame: function() {
		...
		cc.CCDirector.getInstance().replaceScene(cc.layerandscenes.CCTransitionFade.create(1.2,scene));
	}
	,init: function() {
		var bRet = false;
		if(cc.layerandscenes.CCLayer.prototype.init.call(this)) {
